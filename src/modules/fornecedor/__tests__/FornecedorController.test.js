import FornecedorController from '../FornecedorController.js';
...
jest.mock('../FornecedorService.js');
jest.mock('../FornecedorSchema.js');
jest.mock('../FornecedorQuerySchema.js');
...
describe('FornecedorController', () => {
  ...
  describe('criar', () => {
    it('deve criar fornecedor com dados válidos', async () => {
      const fornecedor = {
        nome: 'Fornecedor A',
        toObject: () => ({ nome: 'Fornecedor A', _id: '1' }),
      };
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      FornecedorSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
  ...
  describe('atualizar', () => {
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      req.params = { id: '1' };
      FornecedorIdSchema.parse.mockReturnValue('1');
      FornecedorUpdateSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
