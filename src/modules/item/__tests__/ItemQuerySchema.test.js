...
describe('ItemQuerySchema', () => {
  ...
  it('deve invalidar nome vazio', () => {
    ...
    expect(() => ItemQuerySchema.parse(consulta)).toThrow(
  ...
  it('deve invalidar estoque_minimo diferente de true/false', () => {
    ...
    expect(() => ItemQuerySchema.parse(consulta)).toThrow(
      "Estoque mínimo deve ser 'true' ou 'false'",
    );
  });
  ...
  it('deve invalidar paginação inválida', () => {
    ...
    expect(() => ItemQuerySchema.parse({ page: '0' })).toThrow(
      'Page deve ser um número inteiro maior que 0',
    );
    expect(() => ItemQuerySchema.parse({ limite: '101' })).toThrow(
      'Limite deve ser um número inteiro entre 1 e 100',
    );
    expect(() => ItemQuerySchema.parse({ limite: '0' })).toThrow(
      'Limite deve ser um número inteiro entre 1 e 100',
    );
  });
