...
describe('OrcamentoController', () => {
    ...
    it('deve criar orçamento válido e retornar 201', async () => {
          ...
          itens: [
            {
              ...
              fornecedor: '507f1f77bcf86cd799439013',
              quantidade: '2',
              valor_unitario: '1.5',
            },
            {
              item: '507f1f77bcf86cd799439014',
              fornecedor: '507f1f77bcf86cd799439015',
              quantidade: '1',
              valor_unitario: '2',
            },
          ],
      ...
      expect(res.json).toHaveBeenCalledWith(
        expect.objectContaining({
          data: expect.objectContaining({ nome: 'Orçamento Teste' }),
        }),
      );
    });
  ...
  describe('deletar', () => {
    it('deve deletar orçamento existente', async () => {
      ...
      expect(service.deletar).toHaveBeenCalledWith(
        '507f1f77bcf86cd799439011',
        req,
      );
      expect(res.status).toHaveBeenCalledWith(200);
      expect(res.json).toHaveBeenCalledWith(
        expect.objectContaining({
          message: expect.stringContaining('excluído'),
        }),
      );
    });
    it('deve retornar erro 404 para orçamento inexistente', async () => {
  ...
  describe('adicionarItem', () => {
    it('deve adicionar item válido', async () => {
      const req = {
        params: { orcamentoId: '507f1f77bcf86cd799439011' },
        body: {
          item: '507f1f77bcf86cd799439012',
          fornecedor: '507f1f77bcf86cd799439013',
          quantidade: '2',
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      const req = {
        params: { orcamentoId: '507f1f77bcf86cd799439011' },
        body: { item: '', quantidade: '0', fornecedor: '' },
      };
  ...
  describe('atualizarItem', () => {
    it('deve atualizar item existente', async () => {
      const req = {
        params: {
          orcamentoId: '507f1f77bcf86cd799439011',
          id: '507f1f77bcf86cd799439012',
        },
        body: { quantidade: '5' },
      };
      service.getItemById.mockResolvedValue({
        _id: '507f1f77bcf86cd799439012',
        nome: 'Resistor',
        quantidade: '2',
        valor_unitario: '1.5',
      });
      service.atualizarItem.mockResolvedValue({
        _id: '507f1f77bcf86cd799439011',
        item_orcamento: [{ _id: '507f1f77bcf86cd799439012', quantidade: '5' }],
      });
    ...
    it('deve retornar erro 400 se nenhum campo enviado', async () => {
      ...
      expect(res.json.mock.calls[0][0].errors[0].message).toMatch(
        /nenhum campo/i,
      );
    });
  });
  ...
  describe('removerItem', () => {
    it('deve remover item existente', async () => {
      const req = {
        params: { orcamentoId: '507f1f77bcf86cd799439011', id: 'cid' },
      };
      service.removerItem.mockResolvedValue({
        _id: '507f1f77bcf86cd799439011',
        item_orcamento: [],
      });
      await controller.removerItem(req, res);
      expect(service.removerItem).toHaveBeenCalledWith(
        '507f1f77bcf86cd799439011',
        'cid',
        req,
      );
