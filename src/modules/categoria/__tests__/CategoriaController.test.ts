...
jest.mock('../CategoriaService.js');
jest.mock('../CategoriaSchema.js');
jest.mock('../CategoriaQuerySchema.js');
...
describe('CategoriaController', () => {
  ...
  describe('criar', () => {
    it('deve criar categoria com dados válidos', async () => {
      const categoria = {
        nome: 'Nova Categoria',
        toObject: () => ({ nome: 'Nova Categoria', _id: '1' }),
      };
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      CategoriaSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
  ...
  describe('atualizar', () => {
    ...
    it('deve retornar erro 400 para dados inválidos', async () => {
      req.params = { id: '1' };
      CategoriaIdSchema.parse.mockReturnValue('1');
      CategoriaUpdateSchema.parse.mockImplementation(() => {
        throw { name: 'ZodError' };
      });
