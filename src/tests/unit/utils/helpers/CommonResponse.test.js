...
describe('CommonResponse', () => {
  ...
  describe('serverError', () => {
    ...
    it('deve retornar uma resposta de erro de servidor com mensagem personalizada', () => {
      CommonResponse.serverError(
        res,
        'Mensagem de Erro de Servidor Personalizada',
      );
