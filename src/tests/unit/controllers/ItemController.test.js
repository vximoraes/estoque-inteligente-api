...
describe('ItemController', () => {
    ...
    describe('criar', () => {
        it('deve criar item com dados válidos', async () => {
            const item = { nome: 'Resistor', toObject: () => ({ nome: 'Resistor', _id: '1', ativo: false }) };
        ...
        it('deve retornar erro 400 para dados inválidos', async () => {
            ItemSchema.parse.mockImplementation(() => { throw { name: 'ZodError' }; });
    ...
    describe('atualizar', () => {
        ...
        it('deve retornar erro 400 para dados inválidos', async () => {
            req.params = { id: '1' };
            ItemIdSchema.parse.mockReturnValue('1');
            ItemUpdateSchema.parse.mockImplementation(() => { throw { name: 'ZodError' }; });
    ...
    describe('inativar', () => {
        it('deve inativar item existente', async () => {
            ...
            expect(CommonResponse.success).toHaveBeenCalledWith(res, { nome: 'Item', ativo: false }, 200, 'Item inativado com sucesso.');
        });
